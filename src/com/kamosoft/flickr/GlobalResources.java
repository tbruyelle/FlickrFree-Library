...
public class GlobalResources
{
    ...
    public static String PREF_AUTH_URL = "auth_url";

    public static String PREF_FULL_TOKEN = "full_token";

    public static final String PREF_PERMS = "perms";

    public static final String PREF_USERID = "nsid";
    ...
    public static final String PREF_HASBEENRUN = "HasBeenRun";
    ...
    {
        return ( nsid != "" && a.getSharedPreferences( PREFERENCES_ID, 0 ).getString( PREF_USERID, "" ).equals( nsid ) );
    }
    ...
    public static String downloadImage( String url, String filename, boolean show_progress, Context context )
        throws IOException
    {
    ...
    public static String downloadImage( String url, String filename, String dlpath, boolean show_progress,
                                        Context context )
        throws IOException
    {
        if ( filename.equals( "" ) )
    ...
    public static String GetAppDir()
    {
        ...
        String app_dir = Environment.getExternalStorageState().equals( Environment.MEDIA_MOUNTED ) ? Environment
            .getExternalStorageDirectory().toString() + "/FlickrFree/" : "";
    ...
    public static String GetDownloadDir()
    {
        ...
        // be downloaded.
        String dl_dir = ( app_dir == null ) || app_dir.equals( "" ) ? "" : app_dir + "download";
    ...
    public static boolean CacheImage( String url, Activity callingActivity, boolean show_progress )
    ...
    public static Bitmap GetCachedImage( String url, Activity callingActivity )
        throws MalformedURLException, IOException, InterruptedException
    {
        Bitmap b = null;
        File img_cache = new File( GetCacheDir( callingActivity ) + "/" + CachedImageFilename( url ) );
    ...
    public static String GetBuddyIcon( JSONObject userinfo )
    {
        ...
        {
            icon_url = "http://farm" + iconfarm + ".static.flickr.com/" + iconserver + "/buddyicons/" + nsid + ".jpg";
        }
        else
        {
